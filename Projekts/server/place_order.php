...
if(!isset($_SESSION['logged_in'])){
    ...
    //5. remove everything from cart (delayed for now untill payment is done, whatever)

    // unset($_SESSION['cart']);

    //6. inform user whether everything is fine or there is a problem (Also delayed ig)
